...
class ExercisesWidget(QWidget):
    ...
    def __init__(self):
        ...
        exc1 = MenuButton('Ασκήσεις στους Φυσικούς Αριθμούς', "exercises")
        exc2 = MenuButton('Ασκήσεις στα Κλάσματα', "exercises")
        exc3 = MenuButton('Ασκήσεις στους Δεκαδικοί Αριθμοί', "exercises")
        exc4 = MenuButton("Τελικό Διαγώνισμα", "exercises")
...
(β) του εξαμήνου &
(γ) του έτους &
είναι οι 15 μέρες; (Έστω ότι ο μήνας έχει 30 ημέρες και ο χρόνος 365)
""", ["1/2", "1/12", "3/73"]),
...
""", ["0,437", "0,4375", "1,588", "1,5882", "0,210", "0,2105"]),
            ...
            (ζ) 34.564 &
            (η) 31.549 &
            (θ) 8.765 &""", ["300", "800", "700", "2600", "9500", "123600", "34600", "31500", "8800"]),
            MultipleChoiceQuestion("""Επέλεξε Σωστό ή Λάθος:
            Δεν υπάρχει φυσικός αριθμός μεταξύ των αριθμών 2 και 3""", ["Σωστό", "Λάθος"], 0),
            MultipleChoiceQuestion("Αν το 1/5 ενός κιλού καρύδια είναι 14 καρύδια, το κιλό περιέχει 70 καρύδια;", ["Σωστό", "Λάθος"], 0),
            MultipleChoiceQuestion("Ο αριθμός 13,8432 στρογυλοποιημένος στο πλησιέστερο εκατοστό, γίνεται ίσος με:", ["13,844", "14", "13,843"], 2),
